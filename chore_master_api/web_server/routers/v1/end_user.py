...
# async def post_(
#     end_user_register: EndUserRegisterSchema,
...
#     end_users = list(end_user_collection.find({"email": end_user_register.email}))
#     if len(end_users) > 0:
...
#         "email": end_user_register.email,
#         "password": end_user_register.password,
#     }
